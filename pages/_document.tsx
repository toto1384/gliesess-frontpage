    ...
    return (
        <Html lang='en'>
            ...
            <Head>
                ...
                <script async type="text/partytown" src={`https://www.googletagmanager.com/gtag/js?id=G-LR9E5G7ECB`}></script>
                <script id="dsdfkmsdkfda" type="text/partytown" dangerouslySetInnerHTML={{
